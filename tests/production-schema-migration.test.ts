  ...
  it("applies the complete migration chain to an empty Postgres database", async () => {
    ...
    expect(constraintNames).toEqual(
      expect.arrayContaining([
        ...
        "feedback_reports_idempotency_key_check",
        ...
        "question_similarity_links_distinct_questions_check",
        "question_similarity_links_pkey",
        "question_similarity_links_origin_version_fkey",
        "question_similarity_links_relationship_type_check",
        "question_similarity_links_revocation_check",
        "question_similarity_links_similar_version_fkey",
        "question_similarity_links_slot_check",
    ...
    expect(indexNames).toEqual(
      expect.arrayContaining([
        ...
        "feedback_reports_reporter_idempotency_idx",
        "feedback_reports_reporter_rate_idx",
        "feedback_reports_session_category_idx",
        "hints_question_idx",
        ...
        "question_similarity_links_active_origin_slot_idx",
        "question_similarity_links_active_pair_idx",
        "question_similarity_links_historical_evidence_idx",
        "question_similarity_links_similar_practice_sibling_idx",
