...
| `GET`, `PATCH /api/professor/questions` | Professor | Public-safe review records and mutations. |
| `PATCH /api/professor/questions/[id]` | Professor | Bounded safe metadata edits; private-source fields rejected. |
| `POST /api/professor/questions/[id]/regenerate` | Professor | Deterministic needs-review regeneration. |
