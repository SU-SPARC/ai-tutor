...
| `AI_REQUEST_TIMEOUT_MS`                 | AI/reliability   | No      | Required when AI is enabled in Staging or Production. Must be between `1000` and `8000`; defaults to `8000` outside strict environments.                                                                                                                      |
